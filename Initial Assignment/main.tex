...
\begin{enumerate}
	...
	\item{The locus of the centre of a circle which touches the circle $|z-z_1|=a$ and $|z-z_2|=b$ externally \brak{z, z_1, z_2 \text{ are complex numbers}} will be \hspace*{\fill} [2002]
		\\
		\center
		\begin{tabular}{l l}
	...
	\item{If $z_1$ and $z_2$ are two non-complex numbers such that $|z_1 + z_2| = |z_1| + |z_2|$, then arg\brak{z_1} - arg\brak{z_2} is equal to\hspace*{\fill} [2005]
		\\
		\center
		\begin{tabular}{l l l l}
